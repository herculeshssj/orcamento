...
@Component("movimentacaoLancamentoCartaoMB")
@Scope("session")
public class MovimentacaoLancamentoCartaoController extends AbstractController {
	...
	public MovimentacaoLancamentoCartaoController() {
	...
	public String moverView() {
		try {
			...
			return "/pages/LancamentoCartao/moverLancamentoCartao";
		} catch (Exception e) {
