...
//		}
//		return Util.arredondar(total);
		return LancamentoContaUtil.calcularSaldoLancamentosComConversao(lancamentos);
	}
...
//		
//		return categorias;
		return LancamentoContaUtil.organizarLancamentosPorCategoria(lancamentos);
	}
...
//			
//		return favorecidos;
		return LancamentoContaUtil.organizarLancamentosPorFavorecido(lancamentos);
	}
...
//		return meiosPagamento;
		return LancamentoContaUtil.organizarLancamentosPorMeioPagamento(lancamentos);
	}
...
//			
//		return moedas;
		return LancamentoContaUtil.organizarLancamentosPorMoeda(lancamentos);
	}
