...
public class WadlMethod {
    ...
    protected WadlRequest request;
    protected List<WadlResponse> response;
     ...
     *     
     */
    public void setRequest(WadlRequest value) {
        this.request = value;
    }
     ...
     * 
     */
    public List<WadlResponse> getResponse() {
        if (response == null) {
            response = new ArrayList<WadlResponse>();
        }
