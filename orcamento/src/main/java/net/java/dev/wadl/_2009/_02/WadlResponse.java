...
public class WadlResponse {
    ...
    protected List<WadlParam> param;
    protected List<WadlRepresentation> representation;
     ...
     * 
     */
    public List<WadlParam> getParam() {
        if (param == null) {
            param = new ArrayList<WadlParam>();
        }
        return this.param;
    }
     ...
     * 
     */
    public List<WadlRepresentation> getRepresentation() {
        if (representation == null) {
            representation = new ArrayList<WadlRepresentation>();
        }
