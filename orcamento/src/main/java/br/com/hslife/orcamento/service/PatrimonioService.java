...
import br.com.hslife.orcamento.repository.PatrimonioRepository;

@Service
public class PatrimonioService extends AbstractCRUDService<Patrimonio> implements IPatrimonio {
	
	@Autowired
	private PatrimonioRepository repository;
	
	public PatrimonioRepository getRepository() {
