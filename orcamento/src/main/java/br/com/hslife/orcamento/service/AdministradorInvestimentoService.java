...
@Service
public class AdministradorInvestimentoService extends AbstractCRUDService<AdministradorInvestimento> implements IAdministradorInvestimento {

	@Autowired
	private AdministradorInvestimentoRepository repository;
	
	public AdministradorInvestimentoRepository getRepository() {
	...
	public List<AdministradorInvestimento> findAllByNomeAndUsuario(String nome, Usuario usuario) {
		return getRepository().findAllByNomeAndUsuario(nome, usuario);
	}
}
