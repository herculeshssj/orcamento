...
import br.com.hslife.orcamento.repository.BenfeitoriaRepository;

@Service
public class BenfeitoriaService extends AbstractCRUDService<Benfeitoria> implements IBenfeitoria {
	
	@Autowired
	private BenfeitoriaRepository repository;
	
	public BenfeitoriaRepository getRepository() {
	...
	public List<Benfeitoria> buscarTodosPorPatrimonioEBenfeitoria(Patrimonio patrimonio, Usuario usuario) {
		return getRepository().findAllByPatrimonioAndUsuario(patrimonio, usuario);
	}
}
