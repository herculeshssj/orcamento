...
public class RelatorioColunaComparator implements Comparator<RelatorioColuna>{

	@Override
	public int compare(RelatorioColuna oneEntity, RelatorioColuna otherEntity) {
		if (oneEntity != null && otherEntity != null) {
			if (oneEntity.getOrdem() < otherEntity.getOrdem())
				return -1;
			if (oneEntity.getOrdem() > otherEntity.getOrdem())
				return 1;
			if (oneEntity.getOrdem() == otherEntity.getOrdem())
