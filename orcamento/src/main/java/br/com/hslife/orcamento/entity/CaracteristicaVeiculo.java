...
@Entity
@Table(name="caracteristicaveiculo")
public class CaracteristicaVeiculo extends EntityPersistence {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7265967327831058662L;
