...
import br.com.hslife.orcamento.repository.CombustivelRepository;

@Service
public class CombustivelService extends AbstractCRUDService<Combustivel> implements ICombustivel {
	...
	@Override
	public List<Combustivel> buscarPorDescricao(String descricao) {
