...
public class DetalheOrcamentoComparator implements Comparator<DetalheOrcamento>{

	@Override
	public int compare(DetalheOrcamento oneEntity, DetalheOrcamento otherEntity) {
		try {
