...
@Service
public class CategoriaInvestimentoService extends AbstractCRUDService<CategoriaInvestimento> implements ICategoriaInvestimento{

	@Autowired
	private CategoriaInvestimentoRepository repository;
	
	public CategoriaInvestimentoRepository getRepository() {
	...
	public List<CategoriaInvestimento> buscarPorDescricaoETipoEAtivo(String descricao, TipoInvestimento tipo, Boolean ativo) {
		return getRepository().findByDescricaoAndTipoAndAtivo(descricao, tipo, ativo);
	}
}
