...
@Component
@Scope("session")
public class MontadoraController extends AbstractCRUDController<Montadora>{
	...
	@Override
	public void find() {
		listEntity = getService().buscarPorDescricao(descricaoMontadora);
	}

	/**
	 * @return the descricaoMontadora
	 */
	...
	/**
	 * @param descricaoMontadora the descricaoMontadora to set
	 */
