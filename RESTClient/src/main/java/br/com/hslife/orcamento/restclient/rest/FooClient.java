...
/**
 * Jersey REST client generated for REST resource:application [foo]<br>
 * USAGE:
 * <pre>
 ...
 * @author herculeshssj
 */
public class FooClient implements IClienteREST {
    ...
    public FooClient() {
        ...
        webTarget = client.target(BASE_URI).path("foo");
    }
    ...
    @Override
    public void execute() {
        System.out.println(new FooClient().getAll_JSON(String.class));
    }
}
